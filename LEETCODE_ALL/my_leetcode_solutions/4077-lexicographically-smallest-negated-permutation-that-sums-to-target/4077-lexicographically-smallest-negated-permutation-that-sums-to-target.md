<h1>4077 - Lexicographically Smallest Negated Permutation that Sums to Target</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/lexicographically-smallest-negated-permutation-that-sums-to-target/">lexicographically-smallest-negated-permutation-that-sums-to-target</a></h2><p>You are given a positive integer <code>n</code> and an integer <code>target</code>.</p>
