<h1>4048 - Minimum Time to Complete All Deliveries</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/minimum-time-to-complete-all-deliveries/">minimum-time-to-complete-all-deliveries</a></h2><p>You are given two integer arrays of size 2: <code>d = [d<sub>1</sub>, d<sub>2</sub>]</code> and <code>r = [r<sub>1</sub>, r<sub>2</sub>]</code>.</p>
